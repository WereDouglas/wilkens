        ...
        <table cellpadding="0" cellspacing="0" class="table-responsive parent-table par">
            ...
            <?php foreach ($requisitions as $requisition):
                ...
                <tr>
                    ...
                    <td><?= $requisition->has('user') ? $this->Html->link($requisition->user->full_name,
                            ['controller' => 'Users', 'action' => 'view', $requisition->user->id]) : '' ?></td>
                    <td><?= $requisition->has('property') ? $this->Html->link($requisition->property->name,
                            ['controller' => 'Properties', 'action' => 'view', $requisition->property->id]) : '' ?></td>
                    <td><?= $requisition->has('unit') ? $this->Html->link($requisition->unit->name,
                            ['controller' => 'Units', 'action' => 'view', $requisition->unit->id]) : '' ?></td>

                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $requisition->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $requisition->id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $requisition->id],
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'),
                                            ['controller' => 'expenses', 'action' => 'view', $expense->id]) ?>
                                        <?= $this->Html->link(__('Edit'),
                                            ['controller' => 'expenses', 'action' => 'edit', $expense->id]) ?>
