                                            ...
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <?= $this->Html->link(__('View'),
                                                        ['controller' => 'Contacts', 'action' => 'view', $contacts->id]) ?>
                                                    <?= $this->Html->link(__('Edit'),
                                                        ['controller' => 'Contacts', 'action' => 'edit', $contacts->id]) ?>
                                                    <?= $this->Form->postLink(__('Delete'),
                                                        ['controller' => 'Contacts', 'action' => 'delete', $contacts->id], [
                                            ...
                                            <h4 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion_17"
                                                   ...
                                                   aria-controls="collapseOne_17">
                                                    <i class="material-icons">perm_contact_calendar</i> Related Permissions
                                                </a>
                                            </h4>
                                        </div>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0">
                                                            ...
                                                            <?php foreach ($user->clients as $clients): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="actions">
                                                                        <?= $this->Html->link(__('View'),
                                                                            ['controller' => 'Clients', 'action' => 'view', $clients->id]) ?>
                                                                        <?= $this->Html->link(__('Edit'),
                                                                            ['controller' => 'Clients', 'action' => 'edit', $clients->id]) ?>
                                                                        <?= $this->Form->postLink(__('Delete'),
                                                        ...
                                                        <table cellpadding="0" cellspacing="0">
                                                            ...
                                                            <?php foreach ($user->employees as $employees): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="actions">
                                                                        <?= $this->Html->link(__('View'),
                                                                            ['controller' => 'Employees', 'action' => 'view', $employees->id]) ?>
                                                                        <?= $this->Html->link(__('Edit'),
                                                                            ['controller' => 'Employees', 'action' => 'edit', $employees->id]) ?>
                                                                        <?= $this->Form->postLink(__('Delete'),
                                                                            ['controller' => 'Employees', 'action' => 'delete', $employees->id],
                                                                            ['confirm' => __('Are you sure you want to delete # {0}?', $employees->id)]) ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0">
                                                            ...
                                                            <?php foreach ($user->properties as $properties): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="actions">
                                                                        <?= $this->Html->link(__('View'),
                                                                            ['controller' => 'Properties', 'action' => 'view', $properties->id]) ?>
                                                                        <?= $this->Html->link(__('Edit'),
                                                                            ['controller' => 'Properties', 'action' => 'edit', $properties->id]) ?>
                                                                        <?= $this->Form->postLink(__('Delete'),
                                                                            ['controller' => 'Properties', 'action' => 'delete', $properties->id],
                                                                            ['confirm' => __('Are you sure you want to delete # {0}?', $properties->id)]) ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                        </table>
                                            ...
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                   ...
                                                   aria-controls="collapseTwo_17">
                                                    <i class="material-icons">cloud_download</i> Related Roles
                                                </a>
                                            </h4>
                                        </div>
                                            ...
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                   ...
                                                   aria-controls="collapseThree_17">
                                                    <i class="material-icons">contact_phone</i> Related Users
                                                </a>
                                            </h4>
                                        </div>
                                            ...
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                   ...
                                                   aria-controls="collapseFour_17">
                                                    <i class="material-icons">folder_shared</i> Related Accounts
                                                </a>
                                            </h4>
                                        </div>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach ($user->deposits as $deposits): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View'),
                                                    ['controller' => 'Deposits', 'action' => 'view', $deposits->id]) ?>
                                                <?= $this->Html->link(__('Edit'),
                                                    ['controller' => 'Deposits', 'action' => 'edit', $deposits->id]) ?>
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Deposits', 'action' => 'delete', $deposits->id], [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $deposits->id)
                                                    ]) ?>
                                            </td>
                                ...
                                <?php foreach ($user->rents as $rents): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rents->id],
                                                [
                                                    'confirm' => __('Are you sure you want to delete # {0}?',
                                                        $rents->id)
                                                ]) ?>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach ($user->damages as $damages): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View'),
                                                    ['controller' => 'Damages', 'action' => 'view', $damages->id]) ?>
                                                <?= $this->Html->link(__('Edit'),
                                                    ['controller' => 'Damages', 'action' => 'edit', $damages->id]) ?>
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Damages', 'action' => 'delete', $damages->id], [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $damages->id)
                                                    ]) ?>
                                            </td>
                                    ...
                                    <?php foreach ($user->evictions as $evictions): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Evictions', 'action' => 'delete', $evictions->id],
                                                    [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $evictions->id)
                                                    ]) ?>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach ($user->kins as $kins): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View'),
                                                    ['controller' => 'Kins', 'action' => 'view', $kins->id]) ?>
                                                <?= $this->Html->link(__('Edit'),
                                                    ['controller' => 'Kins', 'action' => 'edit', $kins->id]) ?>
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Kins', 'action' => 'delete', $kins->id], [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $kins->id)
                                                    ]) ?>
                                            </td>
                                    ...
                                    <?php foreach ($user->passwords as $passwords): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Passwords', 'action' => 'delete', $passwords->id],
                                                    [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $passwords->id)
                                                    ]) ?>
                                    ...
                                    <?php foreach ($user->penalties as $penalties): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Penalties', 'action' => 'delete', $penalties->id],
                                                    [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $penalties->id)
                                                    ]) ?>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach ($user->refunds as $refunds): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View'),
                                                    ['controller' => 'Refunds', 'action' => 'view', $refunds->id]) ?>
                                                <?= $this->Html->link(__('Edit'),
                                                    ['controller' => 'Refunds', 'action' => 'edit', $refunds->id]) ?>
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Refunds', 'action' => 'delete', $refunds->id], [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $refunds->id)
                                                    ]) ?>
                                            </td>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <?php foreach ($user->tenants as $tenants): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <?= $this->Html->link(__('View'),
                                                    ['controller' => 'Tenants', 'action' => 'view', $tenants->id]) ?>
                                                <?= $this->Html->link(__('Edit'),
                                                    ['controller' => 'Tenants', 'action' => 'edit', $tenants->id]) ?>
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Tenants', 'action' => 'delete', $tenants->id], [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $tenants->id)
                                                    ]) ?>
                                            </td>
                                    ...
                                    <?php foreach ($user->utilities as $utilities): ?>
                                        <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <?= $this->Form->postLink(__('Delete'),
                                                    ['controller' => 'Utilities', 'action' => 'delete', $utilities->id],
                                                    [
                                                        'confirm' => __('Are you sure you want to delete # {0}?',
                                                            $utilities->id)
                                                    ]) ?>
