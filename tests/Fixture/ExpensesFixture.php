...
class ExpensesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'expenses_requistions_no_FK' => ['type' => 'foreign', 'columns' => ['no'], 'references' => ['requisitions', 'no'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '3a64e221-5ea9-4b26-83c8-a25dcf74bd69',
                'item' => 'Lorem ipsum dolor sit amet',
                'qty' => 1,
                'cost' => 1,
                'total' => 1,
                'created_at' => 1543007896,
                'requisition_id' => '11894c2c-6aaa-47a0-bcb3-d8b8a9028974',
