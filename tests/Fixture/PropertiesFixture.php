...
class PropertiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'legal_id' => ['type' => 'string', 'length' => 36, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_properties_clients1_idx' => ['type' => 'index', 'columns' => ['client_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'lat' => 1,
                'commission' => 1,
                'created_at' => 1540829468,
                'client_id' => 'fab95155-5927-40dd-836b-ef79b24fc6b8'
            ],
        ];
        parent::init();
    }
