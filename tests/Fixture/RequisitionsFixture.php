...
class RequisitionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'no' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'paid_by' => ['type' => 'string', 'length' => 36, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'requested_by_id' => ['type' => 'string', 'length' => 36, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'manager_id' => ['type' => 'string', 'length' => 36, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_requisitions_clients1_idx' => ['type' => 'index', 'columns' => ['client_id'], 'length' => []],
            'fk_requisitions_companies1_idx' => ['type' => 'index', 'columns' => ['company_id'], 'length' => []],
            'fk_requisitions_properties1_idx' => ['type' => 'index', 'columns' => ['property_id'], 'length' => []],
        ],
        '_constraints' => [
