...
class RolesUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_roles_has_users_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_roles_has_users_roles1_idx' => ['type' => 'index', 'columns' => ['role_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'role_id' => 1,
                'user_id' => '06417f7c-1fec-4393-9f8b-687e3c1e929b'
            ],
        ];
        parent::init();
    }
