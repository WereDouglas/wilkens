...
class TenantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'work_address' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '5cfd8a89-ca90-42da-9648-e1e5c7f49bad',
                'start_date' => 'Lorem ip',
                'end_date' => 'Lorem ip',
                ...
                'created_at' => 1543079129,
                'user_id' => '7cea3439-69f6-40ae-b2bf-c69476e85511'
            ],
        ];
        parent::init();
    }
